...
def http_asset_menu() -> None:
    ...
    #criar definição de contrato para o asset
    ...
    proceed = input("Do you want to create the catalog asset? (y/n): ").strip().lower()
    if proceed == 'y':
        ...
        print("Skipping catalog asset creation.")
        catalog_asset_id = "linked-asset-provider-qna"
    ...
    #criar definição de contrato para o catalog asset
...
def mongo_asset_menu() -> None:
    ...
    catalog_asset_id = create_catalog_asset(
        provider_catalog_url, "linked-asset-provider-qna", "This is a linked asset that points to the catalog of the provider's Q&A department.", catalog_url
    )
